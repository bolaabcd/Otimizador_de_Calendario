...
# Function to get incompatible times
...
# Function to check if times are valid (doesn't begin after ends, no intersection inside a time-option)
...
# Function to get a pulp problem, ready to be solved by some solver
...
# Function for debugging to see the solution
